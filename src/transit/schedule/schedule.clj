...
(defn print-lateness
  []
  (print-msg " " (.toString (java.util.Date. (System/currentTimeMillis))))
  (print-msg " " "lateness: " @lateness)
  (print-msg " " "max-lateness: " @max-lateness)
  (print-msg " " "lateness-vector: " ((lateness-vector :get)))
  )
